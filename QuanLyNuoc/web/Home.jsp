                        ...
                        <tbody>
                            <c:forEach items="${listP}" var="o" >
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="openEdit('${o.getId()}','${o.getName()}','${o.getEmail()}','${o.getAddress()}','${o.getPhone()}','${o.getNumberWater()}','${o.getTotalMoney()}')"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a onclick="openDelete(${o.getId()})"  class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                    ...
                    <form action ="add" method="post">  
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name ="NumberWater" type="number" class="form-control" required>
                            </div>	
                            <div class="form-group">
                                <label>Total Money</label>
                                <input name ="TotalMoney" type="number" class="form-control" required>
                            </div>	
                        </div>
